...
fun main() {
    ...
    fun part1(input: List<String>): Long? {
        ...
        while(toVisit.isNotEmpty()) {
            ...
            val nextClockwise = nextClockwise(current, map)
            updateCost(nextClockwise, cost + 1001)

            val nextCounterClockwise = nextCounterClockwise(current, map)
            updateCost(nextCounterClockwise, cost + 1001)
        }
